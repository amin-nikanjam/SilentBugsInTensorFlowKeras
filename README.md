...
This Replication Package is intended for replication of results presented in the paper "Silent Bugs in Deep Learning Frameworks: An Empirical Study of Keras and TensorFlow" submitted to the journal of Empirical Software Engineering in Dec 2022. It contains the data and artifacts used in the paper.
